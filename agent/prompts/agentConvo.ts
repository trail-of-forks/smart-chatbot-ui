export const systemPrefix = `Assistant is a large language model trained by OpenAI.
...
export const formatPrompt = `RESPONSE FORMAT INSTRUCTIONS
----------------------------
...
{{
    "action": "Final Answer",
    "action_input": string \\ You should put what you want to return to use here. Use markdown to format your answer. When displaying images, use the following format: ![caption](url) .
}}
\`\`\``;
...
export const toolResponsePrompt = `TOOL RESPONSE:
---------------------
{observation}
